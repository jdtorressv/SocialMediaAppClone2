...
app.post('/signup', (req, res) => {
    ...
    if (isEmpty(newUser.email)) errors.email = "Must not be be empty";
    else if (!isEmail(newUser.email)) errors.email = "Email address must be valid";
    if (isEmpty(newUser.password)) errors.password = "Must not be be empty";
    if (newUser.password !== newUser.confirmPassword) errors.confirmPassword = "Passwords must match";
    if (isEmpty(newUser.handle)) errors.handle = "Must not be be empty";
